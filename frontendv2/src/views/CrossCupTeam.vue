          ...
          <v-card-text>
            ...
            <div>
              ...
              <v-row>
                ...
                ></v-col>
                <v-col cols="12" sm="1">
                  <v-btn small target="__blank__" :href="`/AcaPointscompetitionresult/?ordering=place&pointscompetitionid=${RoadCupCategorySelector.pointscompetitionid}&racegroupid=${RoadCupCategorySelector.racegroupid}&export=csv&type=roadcupteam`" v-if="RoadCupCategorySelector">Export CSV</v-btn>
                </v-col>
              </v-row>
              <v-row>
                <v-col>
