...
export default {
  ...
  watch:{
    ...
    RoadCupCategorySelector(value){
      ...
      CycAxios.get(`/AcaPointscompetitionresult/?ordering=place&pointscompetitionid=${value.pointscompetitionid}&racegroupid=${value.racegroupid}&fields=place,points,firstname,lastname,usac,currentcat,racingage`).then((data) => {
        console.log(data);
  ...
  methods: {
    getCupDetails() {
      CycAxios.get(`/AcaPointscompetition/?name=BAR`).then((data) => {
        console.log(data);
    ...
    getCategory() {
      ...
      CycAxios.get(`/AcaPointscompetitionraceresult/?ordering=place&pointscompetitionid=${this.RoadCupSelected.id}&fields=racegroupname,id,racegroupid,pointscompetitionid`).then((data) => {
        console.log(data);
