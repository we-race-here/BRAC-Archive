...
class AcaClubstate(models.Model):
    ...
    contactperson = models.ForeignKey('AcaUser', models.DO_NOTHING, db_column='contactPerson', blank=True, null=True)  # Field name made lowercase.
    url = models.CharField(max_length=255, blank=True, null=True)
    email = models.CharField(max_length=255, blank=True, null=True)
    president = models.ForeignKey('AcaUser', models.DO_NOTHING, db_column='president', blank=True, null=True, related_name='acaUser')
...
class AcaEventpointquantifier(models.Model):
    eventid = models.PositiveIntegerField(db_column='eventId')  # Field name made lowercase.
    racegroupid = models.PositiveIntegerField(db_column='racegroupId')  # Field name made lowercase.
...
class AcaTeamresultsbyevent(models.Model):
    competitionid = models.PositiveIntegerField(db_column='competitionId')  # Field name made lowercase.
    eventid = models.PositiveIntegerField(db_column='eventId', blank=True, null=True)  # Field name made lowercase.
    racetype = models.CharField(db_column='raceType', max_length=16, blank=True, null=True)  # Field name made lowercase.
    clubid = models.PositiveIntegerField(db_column='clubId', blank=True, null=True)  # Field name made lowercase.
    racegroupid = models.PositiveIntegerField(db_column='raceGroupId', blank=True, null=True)  # Field name made lowercase.
...
class AcaUser(models.Model):
    ...
    isnewlicense = models.PositiveIntegerField(db_column='isNewLicense')  # Field name made lowercase.
